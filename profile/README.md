...
All visualizations, data, and articles produced and published by Our World in Data are completely open access under the [Creative Commons BY license](https://creativecommons.org/licenses/by/4.0/). Our software code is published on GitHub for transparency. Reuse requires written permission from Global Change Data Lab. Earlier versions of our code remain available under the MIT License via git history.
